      ...
      REAL*8, PARAMETER :: THICKNESS = 60.D-3   ! mm
      ...
      REAL*8, PARAMETER :: PROBE_LAYER = 39      ! The layer where increment adjustment begins
      REAL*8, PARAMETER, DIMENSION(3) :: PROBE_COORDS = (/0.6D0,4.2D0,PROBE_LAYER*THICKNESS/)
      
      ! Code
      CHARACTER(*), PARAMETER :: LSREVNT = 'Event_series_Heat_mm.inp.inp'
      CHARACTER(*), PARAMETER :: COUTPUT = 'run_Exp000.csta'
