...
def Generate_Step_files_for_layer(self,layer):
    ...
    *TIME POINTS, NAME=LASERON, GENERATE
    ...
    #print rolling step
    f.write(step_text.format(1, 1 ,dosing_time/4 , dosing_time, dosing_time/4,freq ,""))
    #print scanning step
    f.write(step_text.format(2, 2 , scan_time/20 , scan_time, scan_time/20,freq ,""))
    #prints short increment cooling step
    f.write(step_text.format(3, 3 , 0.2, 0.2, 0.2,freq ,""))
    #print long increment cooling step
    f.write(step_text.format(4, 4 , 1.0, inter_layer_time, 1.0,freq ,""))
